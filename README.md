...
```bash
docker build --target development --no-cache --tag fcp-sfd-techspike-uploader:development .
```

Run:

```bash
docker run -e PORT=3001 -p 3001:3001 fcp-sfd-techspike-uploader:development
```
...
```bash
docker build --no-cache --tag fcp-sfd-techspike-uploader .
```

Run:

```bash
docker run -e PORT=3001 -p 3001:3001 fcp-sfd-techspike-uploader
```
